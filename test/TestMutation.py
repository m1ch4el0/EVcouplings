...
class TestMutation(TestCase):
    ...
    def test_single_mutant_matrix(self):
        ...
        # TODO _singles int32 singles int64
        pd.testing.assert_frame_equal(
            singles, _singles, check_exact=False, check_dtype=False
        )
...
class TestMutationComplex(TestCase):
    ...
    def test_predict_mutation_table_segment_column(self):
        ...
        pd.testing.assert_frame_equal(self.singles, _singles, check_exact=False)
